...
\end{abstract}
% TODO: modifier à la fin => ça me paraît bien
...
% TODO: slighlty change the focus wrt CC. => Suggestion (too long but something like this) "Our survey contains questions to assess" -> To grasp the extent of concern about climate change (CC) and the willingness to tackle it, our survey assesses -> On dit que c'est ok comme ça, on ne change rien ? => oui
...
% \end{tabular} 
% } \\ \quad \\ {\footnotesize \textsc{Note:} Standard errors are reported in parentheses. Omitted variables are \uline{Yellow Vests: opposes}, \uline{Left-right: Indeterminate} and \uline{Size of town: rural}. Additional covariates are defined in Appendix \ref{app:covariates}.}
% \end{table*} 
...
% \begin{enumerate}[resume,leftmargin=*]
% \item Do you smoke regularly? \uline{Yes; No }
...
% \uline{}\\
% \uline{This would limit climate change; This would create jobs and
...
% \uline{}\\
% \uline{It is valid: any decrease in emissions goes in the right direction;
