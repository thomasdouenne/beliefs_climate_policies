...
\end{figure}
    ...
    % DONE ", "assuming ... " -> ", assuming that "all ..."
...
% DONE adjustment of others' behavior
...
%\href{http://www.bva.fr/data/sondage/sondage_fiche/1063/fichier_bva_actuc0a25.pdf }{BVA (2011)} indicates that, to save energy, 76\% plan to ``change their consumption habits'' and 61\% plan works in their accomodation.
...
% 30% think their household would lose from an increase in taxes on gas and domestic fuel redistributed to all, among those who use neither of these
% DONE equally redistributed...
...
% DONE Tax \& dividend -> the Tax \& Dividend TODO: same in other paper, as well as energies -> energy
...
% DONE comparison between standards and price instruments for urban transport policies confirms the preference for the former -> next sentence
...
\label{fig:diesel}
\end{figure}
% DONE we therefore ask -> we ask  ... therefore
