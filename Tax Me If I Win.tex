...
paid 2.50ï¿½ if they fully complete the survey. The respondents who
...
2ï¿½C is technically feasible. Particulate information consists in the
...
tax by 50ï¿½/t$\text{CO}_{2}$ specific either to heating fuel and gas,
...
to each adult, entailing a yearly transfer of 50ï¿½ (resp. 60ï¿½) for
the partial tax on housing (resp. transport). We also provide the
price increases implied by the tax: +13\% (resp. +15\%) for gas (resp.
domestic fuel) on the one hand, and +0.11ï¿½ (resp. +0.13ï¿½) for a liter
...
(or equivalently, an increase of 0.50ï¿½ in fuel prices), among 5 brackets. 

\paragraph{Compensated Carbon Tax Increase}

\subparagraph{Perceptions \emph{ex ante}}

Our main reform of interest is an increase by 50ï¿½/t$\text{CO}_{2}$
...
<<<<<<< HEAD
receives a yearly compensation of 110ï¿½. This amount was computed using
=======
...
the \emph{Enquï¿½te sur les Revenus Socio-Fiscaux }(ERFS 2014) produced
...
corresponds to that one. When the respondent's income is above 2220ï¿½/month
...
adults in the household earn more than 2220ï¿½/month, their reform is
...
\hline 
Income threshold (ï¿½/month) & 780 & 1140 & 1430 & 1670\tabularnewline
Payment to recipients (ï¿½/year) & 550 & 360 & 270 & 220\tabularnewline
...
income). Also, 58 respondents have answered more than 10,000ï¿½ as their
