...
%\usepackage[left=1.5in,right=1.5in,top=1.5in,bottom=1.5in]{geometry} % AER
\linespread{1.5}
\date{}
...
% TODO: check corrections sur mon .pdf (adrien)
% TODO: show correlation objective - subjective gain / approval
...
Keywords: Climate Policy; Carbon tax; Bias; Beliefs; Preferences; Tax aversion; Perceptions % France; 
...
% TODO Anderson argue (instead of show)
...
% TODO: justifier que c'est pas incentivized (pck dans la vraie vie quand les gens forment leurs opinions politiques, ils sont pas incentivized). les incitations sur leurs gains ça aurait compliqué l'histoire, parce que les gens auraient pas cherché à donner leur vrai gain, mais ce qu'ils pensent que l'on pense être leur vrai gain, ce qui n'est pas forcément la même chose
...
% TODO: Erreur dans Alterea. Faire le calcul nous-mêmes à partir de CGDD (2018): p. 20, on voit que émissions baissent de 450 Mt en 2015 à 85 Mt en 2050, soit -4.6% / an pendant 35 ans.
...
% TODO: retirer "endogenously"? (pareil dans abstract)
...
% TODO: section 3.2 et 4.2 : essayer de creuser l'hétérogénéité des croyances, et de l'effet sur les croyances de l'information fournie
...
% TODO ajouter un genre de "disclaimer" en footnote au début pour prévenir que notre intention n'est pas de pointer du doigt certaines catégories, mais de mettre en évidence des mécanismes cognitifs assez généraux au travers elles.
...
% TODO: rajouter une note sur le fait que le gain moyen en pouvoir d'achat est positif
\begin{figure}[H]
\begin{subfigure}{.5\textwidth}
\centering
...
% TODO: peut-être citer Cantoni et al (QJE, 2019) comme référence pour l'importance de prendre en compte l'hétérogénéité des priors pour éaluer l'effet d'un traitement sur les croyances.
% Au delà de ce papier, on pourrait aussi développer notre littérature sur les papiers empiriques regardant l'effet des croyances sur les attitudes politiques, par exemple en matière de redistribution
...
% Suggestion: on pourrait par simplicité retirer cet Appendix en disant qu'on contrôle déjà pour simule_gain dans la Table 4.2. C'est un peu trompeur car ce n'est pas équivalent, mais ça raccourcit. 
...
% TODO: rajouter le questionnaire, cf. ci-dessous
