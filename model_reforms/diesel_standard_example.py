...
# consuming 1000€ of diesel per year, and using electricity only in housing.
...
def diesel_example(expenditures):
    ...
    current_price = 1.4 # 1.399 # This is roughly the value of gasoline prices
    ...
    dict_diesel['new_expenditures'] = new_expenditures
    dict_diesel['variation_expenditures'] = variation_expenditures
    dict_diesel['new_quantity'] = new_quantity
    dict_diesel['current_quantity'] = current_quantity
    dict_diesel['current_taxes'] = current_taxes
    dict_diesel['new_taxes'] = new_taxes
...
if __name__ == "__main__":
    expenditures = 1000
    example = diesel_example(expenditures)
