...
relabel_and_rename_s <- function() {
  ...
  label(s[[135]]) <<- "~ Ménage Gagnant/Non affecté/Perdant par hausse taxe carbone redistribuée aux 20% des plus modestes (+550€/an/adulte concerné) - Q117"
  ...
  label(s[[147]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes étaient redistribuées aux 50% des plus modestes"
  names(s)[148] <<- "si_compensee"
  label(s[[148]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes étaient redistribuées à tous les français"
  names(s)[149] <<- "si_contraints"
  label(s[[149]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes étaient redistribuées aux ménages contraints à consommer des produits pétroliers"
  names(s)[150] <<- "si_baisse_cotsoc"
  label(s[[150]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient une baisse des cotisations sociales"
  names(s)[151] <<- "si_baisse_tva"
  label(s[[151]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient une baisse de la TVA"
  names(s)[152] <<- "si_baisse_deficit"
  label(s[[152]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient une baisse du déficit public"
  names(s)[153] <<- "si_renovation"
  label(s[[153]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient la rénovation thermique des bâtiments"
  names(s)[154] <<- "si_renouvelables"
  label(s[[154]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient des énergies renouvelables"
  names(s)[155] <<- "si_transports"
  label(s[[155]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'augmentation de la taxe carbone si les recettes financaient des transports non polluants"
  ...
  label(s[[157]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à une taxe sur le kérosène (aviation)"
  names(s)[158] <<- "taxe_viande"
  label(s[[158]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à une taxe sur la viande rouge"
  names(s)[159] <<- "normes_isolation"
  label(s[[159]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à des normes plus strictes sur l'isolation pour les nouveaux bâtiments"
  names(s)[160] <<- "normes_vehicules"
  label(s[[160]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à des normes plus strictes sur la pollution des nouveaux véhicules"
  names(s)[161] <<- "controle_technique"
  label(s[[161]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à des normes plus strictes sur la pollution lors du contrôle technique"
  names(s)[162] <<- "interdiction_polluants"
  label(s[[162]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'interdiction des véhicules polluants dans les centre-villes"
  names(s)[163] <<- "peages_urbains"
  label(s[[163]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à l'instauration de péages urbains"
  names(s)[164] <<- "fonds_mondial"
  label(s[[164]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) à une contribution pour un fond mondial pour le climat"
  names(s)[165] <<- "rattrapage_diesel"
  label(s[[165]]) <<- "~ Le répondant serait favorable (Oui tout à fait/Oui plutôt/Indifférent ou NSP/Non pas vraiment/Non pas du tout) au rattrapage de la fiscalité du diesel sur celle de l'essence (on explique que pour des raisons historiques le diesel est moins taxé)"
  names(s)[166] <<- "parle_CC"
  label(s[[166]]) <<- "~ Fréquence à laquelle le répondant parle du changement climatique (...)"
  names(s)[167] <<- "cause_CC"
  label(s[[167]]) <<- "~ Cause principale du changement climatique selon le répondant (...)"
  names(s)[168] <<- "ges_co2" # TODO: majuscules (tva aussi)
  label(s[[168]]) <<- "~ Le répondant pense que le CO2 participe au réchauffement climatique"
  names(s)[169] <<- "ges_ch4"
  label(s[[169]]) <<- "~ Le répondant pense que le CH4 participe au réchauffement climatique"
  names(s)[170] <<- "ges_o2"
  label(s[[170]]) <<- "~ Le répondant pense que l'oxygène participe au réchauffement climatique"
  names(s)[171] <<- "ges_pm"
  label(s[[171]]) <<- "~ Le répondant pense que les particules fines participent au réchauffement climatique"
  names(s)[172] <<- "ges_boeuf"
  label(s[[172]]) <<- "~ Le répondant pense que la consommation d'un steak haché de boeuf émet environ 20 fois plus de GES que deux portions de pâtes"
  names(s)[173] <<- "ges_nucleaire"
  label(s[[173]]) <<- "Le répondant pense que l'électricité produite au nucléaire émet eviron 20 fois plus de GES que celle produite par les éoliennes"
  names(s)[174] <<- "ges_avion"
  label(s[[174]]) <<- "Le répondant pense qu'une place dans un trajet Bordeaux - Nice émet environ20 fois plus de GES en avion qu'en train"
  names(s)[175] <<- "effets_CC"
  label(s[[175]]) <<- "~ Le répondant pense qu'en l'absence de mesures ambitieuse, les effets du changement climatiques seraient (...)"
  names(s)[176] <<- "region_CC"
  label(s[[176]]) <<- "~ Le répondant pense que le changement climatique aura les plus grandes conséquences en Inde/Europe/autant les deux"
  names(s)[177] <<- "generation_CC_1960"
  label(s[[177]]) <<- "~ Le répondant estime qu'en France les générations nés dans les années 1960 seront gravement affectées par le changeent climatique"
  names(s)[178] <<- "generation_CC_1990"
  label(s[[178]]) <<- "~ Le répondant estime qu'en France les générations nés dans les années 1990 seront gravement affectées par le changeent climatique"
  names(s)[179] <<- "generation_CC_2020"
  label(s[[179]]) <<- "~ Le répondant estime qu'en France les générations nés dans les années 2020 seront gravement affectées par le changeent climatique"
  names(s)[180] <<- "generation_CC_2050"
  label(s[[180]]) <<- "~ Le répondant estime qu'en France les générations nés dans les années 2050 seront gravement affectées par le changeent climatique"
  names(s)[181] <<- "generation_CC_aucune"
  label(s[[181]]) <<- "~ Le répondant estime qu'en France les générations nées dans les années 1960, 1990, 2020 et 2050 ne seront pas gravement affectées par le changeent climatique"
  names(s)[182] <<- "responsable_CC_chacun"
  label(s[[182]]) <<- "~ Le répondant estime que chacun d'entre nous est responsabe du changement climatique"
  names(s)[183] <<- "responsable_CC_riches"
  label(s[[183]]) <<- "~ Le répondant estime que les plus riches sont responsables du changement climatique"
  names(s)[184] <<- "responsable_CC_govts"
  label(s[[184]]) <<- "~ Le répondant estime que les gouvernements sont responsables du changement climatique"
  names(s)[185] <<- "responsable_CC_etranger"
  label(s[[185]]) <<- "~ Le répondant estime que certains pays étrangers sont responsables du changement climatique"
  names(s)[186] <<- "responsable_CC_passe"
  label(s[[186]]) <<- "~ Le répondant estime que les générations passées sont responsables du changement climatique"
  names(s)[187] <<- "responsable_CC_nature"
  label(s[[187]]) <<- "~ Le répondant estime que des causes naturelles sont responsables du changement climatiqu"
  names(s)[188] <<- "emission_cible"
  label(s[[188]]) <<- "~ Le répondant estime que les émissions de CO2 en France (actuellement à 10t/pers./an) devraient être ramenées à Xt/pers/an pour contenir le réchauffement climatique à +2 degrés si tous les pays faisaient de même"
  names(s)[189] <<- "enfant_CC"
  label(s[[189]]) <<- "~ Le changement climatique a, a eu ou aura une influence dans la décision du répondant de faire un enfant (Oui/Non/NSP)"
  names(s)[190] <<- "enfant_CC_pour_lui"
  label(s[[190]]) <<- "~ Le changement climatique a, a eu ou aura une influence dans la décision du répondant de faire un enfant parce qu'il ne veut pas que l'enfant vive dans un monde dévasté"
  names(s)[191] <<- "enfant_CC_pour_CC"
  label(s[[191]]) <<- "~ Le changement climatique a, a eu ou aura une influence dans la décision du répondant de faire un enfant parce qu'il ne veut pas que son enfant aggrave le changement climatique"
  names(s)[192] <<- "changer_si_politiques"
  label(s[[192]]) <<- "~ Le répondant serait prêt à changer son mode de vie pour lutter contre le changement climatique si les politiques allaient dans ce sens"
  names(s)[193] <<- "changer_si_moyens"
  label(s[[193]]) <<- "~ Le répondant serait prêt à changer son mode de vie pour lutter contre le changement climatique s'il en avait les moyens financiers"
  names(s)[194] <<- "changer_si_tous"
  label(s[[194]]) <<- "~ Le répondant serait prêt à changer son mode de vie pour lutter contre le changement climatique si tout le monde en faisait autant"
  names(s)[195] <<- "changer_non_riches"
  label(s[[195]]) <<- "~ Le répondant ne serait pas prêt à changer son mode de vie pour lutter contre le changement climatique car seuls les plus riches doivent changer leur mode de vie"
  names(s)[196] <<- "changer_non_interet"
  label(s[[196]]) <<- "~ Le répondant ne serait pas prêt à changer son mode de vie pour lutter contre le changement climatique car s'oppose à son intérêt personnel"
  names(s)[197] <<- "changer_non_negation"
  label(s[[197]]) <<- "~ Le répondant ne serait pas prêt à changer son mode de vie pour lutter contre le changement climatique car il pense que le changement climatique n'est pas un vrai problème"
  names(s)[198] <<- "changer_deja_fait"
  label(s[[198]]) <<- "~ Le répondant ne serait pas prêt à changer son mode de vie pour lutter contre le changement climatique car il a déjà adopté un mode de vie soutenable"
  names(s)[199] <<- "changer_essaie"
  label(s[[199]]) <<- "~ Le répondant essaie de changer son mode de vie pour lutter contre le changement climatique mais a du mal à changer ses habitudes"
  names(s)[200] <<- "mode_vie_ecolo"
  label(s[[200]]) <<- "~ Dans l'hypothèse où tous les Etats du monde se mettraient d'accord pour lutter contre le changement climatique, mettraient à contribution les plus riches, et si la France investissait dans les transports non polluants, le répondant serait prêt (Oui/Non/NSP) à adopter un mode d evie écologique"
  names(s)[201] <<- "fume"
  label(s[[201]]) <<- "~ Le répondant fume régulièrement (Oui/Non)"
  names(s)[202] <<- "schiste_approbation"
  label(s[[202]]) <<- "Après avoir été informé des avantages du gaz de schiste vis-à-vis de la réduction des émissions, de son effet négatif sur la qualité de l'eau à l'échelle locale, et des potentiels d'exploitation dans son département, le répondant serait favorable (Oui/Non/NSP) à son exploitation"
  names(s)[203] <<- "schiste_avantage"
  label(s[[203]]) <<- "~ Le répondant considère que le principal avantage de l'exploitation du gaz de schiste serait la lutte contre le changement climatique / la création d'emploi dans les départements concernés / aucune de ces deux raisons"
  names(s)[204] <<- "schiste_CC"
  label(s[[204]]) <<- "~ Le répondant estime que l'idée que le gaz de schiste permettrait de lutter contre le changement climatique est valable / malvenue / il ne sait pas"
  names(s)[205] <<- "transports_distance_choix"
  label(s[[205]]) <<- "~ Le répondant peut estimer la distance de l'arrêt de transport en commun le plus proche de chez lui en minutes de marche, ou il ne sait pas"
  names(s)[206] <<- "transports_distance"
  label(s[[206]]) <<- "~ L'arrêt de transport en commun le plus proche de chez le répondant est à X minutes de marche"
  names(s)[207] <<- "transports_frequence"
  label(s[[207]]) <<- "~ Le moyen de transports en commun le plus proche de chez le répondant passe en moyenne (...)"
  names(s)[208] <<- "transports_avis"
  label(s[[208]]) <<- "~ Le répondant estime l'offre de transports en commun là où il habite comme étant (...)"
  names(s)[209] <<- "transports_travail"
  label(s[[209]]) <<- "~ Le répondant utilise principalement (la voiture/...) pour ses trajets domiciles-travail (ou études)"
  names(s)[210] <<- "transports_courses"
  label(s[[210]]) <<- "~ Le répondant utilise principalement (la voiture/...) pour faire ses courses"
  names(s)[211] <<- "transports_loisirs"
  label(s[[211]]) <<- "~ Le répondant utilise principalement (la voiture/...) pour ses loisirs (hors voyages)"
  names(s)[212] <<- "transports_travail_commun"
  label(s[[212]]) <<- "~ Sans changer de logement ni de lieu de travail, il serait possible pour le répondant prenant sa voiture (Non/Oui mais ça l'embetterait/Oui ça ne lui poserait pas de grande difficulté/NSP) de prendre les transports en commun pour ses trajets domicile-travail"
  names(s)[213] <<- "transports_travail_actif"
  label(s[[213]]) <<- "~ Sans changer de logement ni de lieu de travail, il serait possible pour le répondant prenant sa voiture (Non/Oui mais ça l'embetterait/Oui ça ne lui poserait pas de grande difficulté/NSP) d'effectuer ses trajets domicile-travail en marchant ou en vélo"
  names(s)[214] <<- "interet_politique"
  label(s[[214]]) <<- "~ Le répondant est intéressé par la politique (Presque pas/Un peu/Beaucoup)"
  names(s)[215] <<- "extr_gauche"
  label(s[[215]]) <<- "~ Le répondant se considère comme étant d'extrême gauche"
  names(s)[216] <<- "gauche"
  label(s[[216]]) <<- "~ Le répondant se considère comme étant de gauche"
  names(s)[217] <<- "centre"
  label(s[[217]]) <<- "~ Le répondant se considère comme étant du centre"
  names(s)[218] <<- "droite"
  label(s[[218]]) <<- "~ Le répondant se considère comme étant de droite"
  names(s)[219] <<- "extr_droite"
  label(s[[219]]) <<- "~ Le répondant se considère comme étant d'extrême droite"
  names(s)[220] <<- "conservateur"
  label(s[[220]]) <<- "~ Le répondant se considère comme étant conservateur"
  names(s)[221] <<- "liberal"
  label(s[[221]]) <<- "~ Le répondant se considère comme étant libéral"
  names(s)[222] <<- "humaniste"
  label(s[[222]]) <<- "~ Le répondant se considère comme étant humaniste"
  names(s)[223] <<- "patriote"
  label(s[[223]]) <<- "~ Le répondant se considère comme étant patriote"
  names(s)[224] <<- "apolitique"
  label(s[[224]]) <<- "~ Le répondant se considère comme étant apolitique"
  names(s)[225] <<- "ecologiste"
  label(s[[225]]) <<- "~ Le répondant se considère comme étant écologiste"
  names(s)[226] <<- "actualite"
  label(s[[226]]) <<- "~ Le répondant se tient principalement informé de l'actualité via la télévision / la presse (écrite ou en ligne) / les réseaux sociaux / la radio"
  names(s)[227] <<- "gilets_jaunes_dedans"
  label(s[[227]]) <<- "~ Le répondant déclare faire partie des gilets jaunes"
  names(s)[228] <<- "gilets_jaunes_soutien"
  label(s[[228]]) <<- "~ Le répondant soutient les gilets jaunes"
  names(s)[229] <<- "gilets_jaunes_compris"
  label(s[[229]]) <<- "~ Le répondant comprend les gilets jaunes"
  names(s)[230] <<- "gilets_jaunes_oppose"
  label(s[[230]]) <<- "~ Le répondant est opposé aux gilets jaunes"
  names(s)[231] <<- "gilets_jaunes_NSP"
  label(s[[231]]) <<- "~ Le répondant ne sait pas s'il fait partie / s'il soutient / s'il comprend / s'il s'oppose aux gilets jaunes"
