...
relabel_and_rename_s <- function() {
  ...
  names(s)[134] <<- "taxe_problemes_autre_p"
  ...
  label(s[[156]]) <<- "Test permettant de vérifier l'attention des répondants - Un peu doit être sélectionné pour montrer que l'on est attentif"
