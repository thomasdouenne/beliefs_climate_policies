...
Table_ee2 <- stargazer(tsls2_ee1, ols_ee2, logit_ee3, tsls2_ee4, tsls2_ee5,
                       ...
                       dep.var.labels = c("Tax Acceptance ($A^0$)", "Tax Approval ($\\dot{A^0}$)"), dep.var.caption = "", header = FALSE,
...
Table_prog_bis <- stargazer(ols_prog1, ols_prog2bis, ols_prog3, logit_prog4, ols_prog5, ols_prog6,
                        ...
                        covariate.labels = c("Progressivity $(P)$", "Income ($I$, in k\\euro{}/month)", "Winner $(G^1)$", "Effective $(E)$", 
                                             "Initial tax Acceptance ($A^0$)", "$(G^1 \\times E)$", # "Initial tax: PNR (I don’t know)", "Initial tax: Approves ($\\dot{A^0}$)", 
                                             "Interaction: winner $(P \\times G^1)$", "Interaction: effective $(P \\times E)$", "Interaction: income $(P \\times I)$",
                                             "$P \\times G^1 \\times E$"), # "Constant",
