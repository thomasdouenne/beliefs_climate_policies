...
if __name__ == "__main__":
    ...
    hh_info['consumption_units'] = 1
    hh_info['natural_gas'] = 0
    hh_info['domestic_fuel'] = 1
    hh_info['accommodation_size'] = 60
    hh_info['hh_income'] = 300000

    hh_info['nb_vehicles'] = 1
    hh_info['energy_first_vehicle'] = 'diesel'
    hh_info['energy_second_vehicle'] = 'gasoline'
    hh_info['avg_fuel_consumption'] = 8 / 100
    hh_info['nb_kilometers'] = 3000
    hh_info['age_18_24'] = 1
    hh_info['age_25_34'] = 0
    hh_info['age_35_49'] = 0
    hh_info['age_50_64'] = 0
    hh_info['nb_beneficiaries'] = 1
